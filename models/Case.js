...
Case.add({
    ...
    '证据材料',
    {
        ...
        委托创作说明形式: {type: Types.Select, options: '纸质单张,光盘批量,其他', label: '委托创作说明形式'},
        委托创作说明提供日期: {type: Types.Date, label: '委托创作说明提供日期'},
        委托创作说明快递公司及单号: {type: String, label: '委托创作说明快递公司及单号'},
    ...
    '诉讼材料',
    {
        ...
        和解协议发出快递公司及单号: {type: String, label: '和解协议发出快递公司及单号'},
        ...
        诉讼材料备注: {type: String, label: '诉讼材料备注'},
    },
    '退费与赔偿',
    {
        律所预付诉讼费金额: {type: Types.Money, label: '律所预付诉讼费金额'},
        律所预付诉讼费日期: {type: Types.Date, label: '律所预付诉讼费日期'},
        公司预付诉讼费金额: {type: Types.Money, label: '公司预付诉讼费金额'},
        公司预付诉讼费日期: {type: Types.Date, label: '公司预付诉讼费日期'},
        "退还诉讼费金额（到律所）": {type: Types.Money, label: '退还诉讼费金额（到律所）'},
        "退还诉讼费日期（到律所）": {type: Types.Date, label: '退还诉讼费日期（到律所）'},
        "退还诉讼费金额（到公司）": {type: Types.Money, label: '退还诉讼费金额（到公司）'},
        "退还诉讼费日期（到公司）": {type: Types.Date, label: '退还诉讼费日期（到公司）'},
        退诉讼费备注: {type: String, label: '退诉讼费备注'},
    ...
    '收据',
    {
        收据开具批次: {type: Number, label: '收据开具批次'},
        退费收据金额: {type: Types.Money, label: '退费收据金额'},
        退费收据收件人: {type: String, label: '退费收据收件人'},
        退费收据开具日期: {type: Types.Date, label: '退费收据开具日期'},
        退费收据快递公司及单号: {type: String, label: '退费收据快递公司及单号'},
        退费收据备注: {type: String, label: '退费收据备注'},
        赔偿款收据金额: {type: Types.Money, label: '赔偿款收据金额'},
        赔偿款收据收件人: {type: String, label: '赔偿款收据收件人'},
