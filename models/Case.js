...
Case.add({
    ...
    '案件基本',
    {
        ...
        侵权形式: {
            type: Types.Select,
            options: '官网(商业),官网(资讯),门户资讯网站,普通资讯网站,企业微博,企业公众号,大型直营电商,小型直营电商,大型电商三方,小型电商三方,大流量APP,其他APP,印刷品,电商,官网,网页资讯,网站,其他',
            label: '侵权形式'
        },
    ...
    '移交律师',
    {
        ...
        负责律所: {type: Types.Select, options: '北京王斌,江苏海辉,上海计易,深圳谢涛,天津肖坤,张宏麟,西安王正兴,其他', label: '负责律所'},
