...
Case.add({
    ...
    '退费与赔偿',
    {
        ...
        "预付日期(一审第三次)": {type: Types.Date, label: '预付日期(一审第三次)'},
        "预付诉讼费(二审)": {type: Types.Money, label: '预付诉讼费(二审)'},
        "预付日期(二审)": {type: Types.Date, label: '预付日期(二审)'},
        "预付立案公告费": {type: Types.Money, label: '预付立案公告费'},
        "预付立案公告费日期": {type: Types.Date, label: '预付立案公告费日期'},
        ...
        "对方承担诉讼费退还日期": {type: Types.Date, label: '对方承担诉讼费退还日期'},
        ...
        "退还诉讼费一审2（到公司）": {type: Types.Money, label: '退还诉讼费一审2（到公司）'},
        "诉讼费退还日期一审2（到公司）": {type: Types.Date, label: '诉讼费退还日期一审2（到公司）'},
        "退费形式一审2（到公司）": {type: Types.Select, options: '银行汇款,现金,法院支票,其他', label: '退费形式一审2（到公司）'},
        "退还诉讼费一审3（到公司）": {type: Types.Money, label: '退还诉讼费一审3（到公司）'},
        "诉讼费退还日期一审3（到公司）": {type: Types.Date, label: '诉讼费退还日期一审3（到公司）'},
        "退费形式一审3（到公司）": {type: Types.Select, options: '银行汇款,现金,法院支票,其他', label: '退费形式一审3（到公司）'},
        "退还诉讼费二审（到公司）": {type: Types.Money, label: '退还诉讼费二审（到公司）'},
