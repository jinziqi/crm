...
Case.add({
        ...
        测试关联序号: {type: Types.Relationship, ref: 'Test', label: '测试关联序号' },
    ...
    '以租代赔',
    {
        ...
        以租代赔批次日期: {type: Types.Date, label: '以租代赔批次日期'},
    ...
    '退费与赔偿',
    {
        ...
        "预付判决公告费": {type: Types.Money, label: '预付判决公告费'},
        "预付判决公告费日期": {type: Types.Date, label: '预付判决公告费日期'},
