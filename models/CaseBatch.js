...
CaseBatch.add({
  ...
  '线索增加',
  {
    ...
    "线索增加数量": {type: Number, label: '线索增加数量'},
  ...
  '主体查询',
  {
    ...
    "主体查询数量": {type: Number, label: '主体查询数量'},
  ...
  '租片查询',
  {
    ...
    "租片查询数量": {type: Number, label: '租片查询数量'},
  ...
  '证据保全',
  {
    ...
    "证据保全数量": {type: Number, label: '证据保全数量'},
  ...
  '案件移交律所',
  {
    ...
    "移交案件数量": {type: Number, label: '移交案件数量'},
